...
var clintonanimation; // animation for clinton
...
function preload()
{
  ...
  // path, width, height, # :
  clintonimage = loadSpriteSheet('./data/clintonspritesheet.png', 50, 50, 3);
  clintonanimation = loadAnimation(clintonimage);
...
function setup() {
  ...
  clintonsprite.addAnimation('go', clintonanimation);
